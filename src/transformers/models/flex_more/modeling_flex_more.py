#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from src/transformers/models/flex_more/modular_flex_more.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_flex_more.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
# coding=utf-8
...
from .configuration_flex_more import FlexMoREConfig


@use_kernel_forward_from_hub("RMSNorm")
class FlexMoRERMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6):
        """
        FlexMoRERMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class FlexMoRERotaryEmbedding(nn.Module):
    inv_freq: torch.Tensor  # fix linting for `register_buffer`

    def __init__(self, config: FlexMoREConfig, device=None):
        super().__init__()
    ...
    def compute_default_rope_parameters(
        config: Optional[FlexMoREConfig] = None,
...
class FlexMoREAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: FlexMoREConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
        ...
        self.q_norm = FlexMoRERMSNorm(config.num_attention_heads * self.head_dim, config.rms_norm_eps)
        self.k_norm = FlexMoRERMSNorm(config.num_key_value_heads * self.head_dim, config.rms_norm_eps)
...
class FlexMoREExperts(nn.ModuleList):
    ...
    def __init__(self, config: FlexMoREConfig):
        super().__init__(
            [FlexMoREExpert(config, rank, alpha) for rank, alpha in zip(config.expert_ranks, config.expert_alphas)]
        )
...
@auto_docstring
class FlexMoREModel(FlexMoREPreTrainedModel):
    def __init__(self, config: FlexMoREConfig):
        ...
        self.layers = nn.ModuleList(
            [FlexMoREDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)]
        )
        self.norm = FlexMoRERMSNorm(config.hidden_size, eps=config.rms_norm_eps)
        self.rotary_emb = FlexMoRERotaryEmbedding(config=config)
...
@auto_docstring
class FlexMoREForCausalLM(FlexMoREPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = FlexMoREModel(config)
        self.vocab_size = config.vocab_size
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, FlexMoREForCausalLM

        >>> model = FlexMoREForCausalLM.from_pretrained("allenai/FlexMoRE-1B-7B-0924")
        >>> tokenizer = AutoTokenizer.from_pretrained("allenai/FlexMoRE-1B-7B-0924")
...
__all__ = ["FlexMoREForCausalLM", "FlexMoREModel", "FlexMoREPreTrainedModel"]
